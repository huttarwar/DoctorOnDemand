...
public class Trending extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request,
		...
		pw.print("<div id='content'><div class='post'><h2 class='title meta'>");
		pw.print("<a style='font-size: 24px;'>Most Popular Services by Zipcode</a>");
		pw.print("</h2><div class='entry'><table id='bestseller'>");
		Iterator itr1 = mostsoldzip.iterator();
         while(itr1.hasNext()) {
         Mostsoldzip mostzip = (Mostsoldzip)itr1.next();
 		pw.print("<tr>");
		pw.println("<td style='font-size: 20px;'>");
		...
		pw.print("<div id='content'><div class='post'><h2 class='title meta'>");
		pw.print("<a style='font-size: 24px;'>Most Services needs</a>");
		pw.print("</h2><div class='entry'><table id='bestseller'>");
        ...
        while(itr.hasNext()) {
 		...
 		pw.println("<tr>");
		pw.println("<td border: 1px style='font-size: 20px;'>");
