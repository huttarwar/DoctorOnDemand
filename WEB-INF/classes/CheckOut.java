...
public class CheckOut extends HttpServlet {
	...
	protected void storeOrders(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		{
			pw.print("<tr><td> Service Booked:</td><td>");
			pw.print(oi.getName()+"</td></tr><tr><td>");
			pw.print("<input type='hidden' name='orderPrice' value='"+oi.getPrice()+"'>");
			pw.print("<input type='hidden' name='orderName' value='"+oi.getName()+"'>");
			pw.print("<input type='hidden' name='itemid' value='"+oi.getName()+"'>");
			pw.print("Service charged:</td><td>"+ oi.getPrice());
			
			pw.print("</td></tr>");
		}
		pw.print("<tr><td>");
        pw.print("Total Cost</td><td>"+orderTotal);
		...
		pw.print("<tr><td>");
		pw.print("Email</td>");
		pw.print("<td><input type='email' name='email'>");
        pw.print("</td></tr>");
		pw.print("<tr><td>");
		pw.print("Phone</td>");
		pw.print("<td><input type='tel' name='phone'>");
        pw.print("</td></tr>");
		pw.print("<tr><td>");
     	pw.print("CreditCard/Mastercard</td>");
