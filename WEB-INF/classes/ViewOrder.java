...
protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		{
			pw.print("<table align='center'><tr><td style='font-size: 20px;'>Enter Order No. &nbsp&nbsp<input name='orderId' type='text'></td>");
		...
		if(request.getParameter("Order")!=null && request.getParameter("Order").equals("ViewOrder"))
		{
			...
			if(request.getParameter("orderId") != null && !request.getParameter("orderId").isEmpty())
			{
				...
				{	
					...
					pw.print("<tr><td></td>");
					pw.print("<td>Service Request:</td>");
					pw.print("<td>User Name:</td>");
					pw.print("<td>Service care:</td>");
					pw.print("<td>Price:</td>");
					pw.print("<td>Appointment requested:</td>");
					...
					for (OrderPayment oi : orderPayments.get(orderId)) 
					{
						...
						pw.print("<td>"+oi.getOrderId()+".</td><td>"+oi.getUserName()+"</td><td>"+oi.getOrderName()+"</td><td> "+oi.getOrderPrice()+"</td><td> "+ oi.getDate()+"</td><td> In Progress </td>");
				...
				for (OrderPayment oi : orderPayments.get(orderId)) 
					{
							if(oi.getOrderName().equals(orderName))
							{
								...
								int ham = 1;
								int inventory = MySqlDataStoreUtilities.updateProducts(orderName,oi.getOrderPrice(),ham);
